...
# ################################################################################################ #
# Default path to the common directory for FireEye VMs
# ################################################################################################ #
...
# Copy the directory for common modules for FireEye VMs to the common directory
